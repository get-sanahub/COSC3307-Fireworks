// Camera class — taken directly from Tutorial 7.
// Pitch, Yaw, Roll and Move functions are fully implemented.
#include <camera.h>


Camera::Camera(void) : position(0.0, 0.0, 0.0), forwardVector(0.0, 0.0, 100.0), upVector(0.0, 1.0, 0.0)
, nearPlane(1), farPlane(5000), fieldOfView(60), aspectRatio(1.0)
{
